...
tifpath = 'H:\TiS2\20201125\TIFF\B5_Li_250mM_0_-0_6V_100mVs_1cycles_BF';
...
tmp1 = imread(fullfile(tifpath,tifobj(1).name));

for i = 1:(length(tifobj)-1)

    tmp2 = imread(fullfile(tifpath,tifobj(i+1).name));
