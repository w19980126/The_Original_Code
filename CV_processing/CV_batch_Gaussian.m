...
hold off 
title([expname  '\_zone' num2str(zone) '\_透射率随帧数变化曲线,Scan Rate:' num2str(scanrate) 'mV/s,Gaussian\_' num2str(r) '\_' num2str(sigma)],'fontsize',15);
...
title([expname '\_zone' num2str(zone) '光学CV曲线,Scan Rate:' num2str(scanrate) 'mV/s,Gaussian\_' num2str(r) '\_' num2str(sigma)],'fontsize',15);
set(gca,'fontsize',15);
axis tight
...
title([expname '\_zone' num2str(zone) '透射率差分随帧数变化趋势,Scan Rate:' num2str(scanrate) 'mV/s,Gaussian\_' num2str(r) '\_' num2str(sigma)],'fontsize',15);
set(gca,'fontsize',15);
axis tight
